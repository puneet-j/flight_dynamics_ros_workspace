...
def start_funct():
    global param,time_old,inp, state, V_a, pub_h, pub_va, pub_chi, pub_phi
...
def set_del_a_r(course_c):
    global state, inp, param, V_a, beta, alpha, wind,err_int_course
...
def propagate(dt):
    ...
    gusts[0][0] = y1[-1]/1000.0
    gusts[1][0] = y2[-1]/1000.0
    gusts[2][0] = y3[-1]/1000.0
    #print gusts
    # if p_d > -alt:
    #     gusts = [[0.0],[0.0],[0.0]]
