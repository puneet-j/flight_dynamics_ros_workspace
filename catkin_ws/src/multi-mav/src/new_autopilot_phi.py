...
def start_funct():
    global param,time_old, state, bphi, pub_h, pub_va, pub_phi
    ...
    pub_h =  rospy.Publisher("/new_autopilot_phi/h_phi", Float32, queue_size=10)
    pub_va =  rospy.Publisher("/new_autopilot_phi/va_phi", Float32, queue_size=10)
    pub_phi =  rospy.Publisher("/new_autopilot_phi/phi_phi", Float32, queue_size=10)
...
def dynamics_timer_callback(self):
    global state,psi, time_old, pub_h, pub_va, pub_phi
